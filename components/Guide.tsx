  ...
  return (
    ...
    <section className='flexCenter flex-col'>
      <div className='padding-container max-container w-full pb-24'>
        ...
        <div className='flex flex-wrap justiy-between gap-5 lg:gap-28 lg:flex-nowrap'>
          <h2 className='bold-40 lg:bold-64 xl:mx-w-[390px] lg:width-[300px]'>Guide You To Easy Path</h2>
